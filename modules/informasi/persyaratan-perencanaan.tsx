...
export default function PersyaratanPerencanaan() {
  return (
    <div className="p-1">
      <h1 className="font-bold text-lg mb-3">Persyaratan Perencanaan</h1>
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="bg-neutral-100 box-shadow-custom rounded-2xl p-5 flex-1 flex flex-col">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h1 className="font-bold text-sm md:text-base text-black">Lokasi</h1>
          </div>

          <div className="flex items-center gap-1.5 font-semibold text-xs md:text-sm text-neutral-900 mb-1.5">
            <ChevronRight className="size-4 text-neutral-700 shrink-0" />
            <span>Keamanan lokasi diantaranya:</span>
          </div>
          <ul className="list-disc list-outside pl-6 text-xs text-neutral-600 space-y-1 mb-4">
          ...
          <ul className="list-disc list-outside pl-6 text-xs text-neutral-600 space-y-1">
        ...
        <div className="bg-neutral-100 box-shadow-custom rounded-2xl p-5 flex-1 flex flex-col">
          ...
          <ul className="list-disc list-outside pl-6 text-xs text-neutral-600 space-y-2 mt-1">
            <li>
